...
{
  listDir(SD, "/", 0);
  fileName = "/" + String(dt.c_str()) + ".txt";
  appendFile(SD, fileName.c_str(), (">>OPENNING NEW SERIAL LOGGER FILE " + dt + "\n").c_str());
  Serial.print("New file opened:");
...
void loop(){
  while (Serial.available()) 
  {
    ...
    else
    {
      ...
      WriteString2BLE(const_cast<char*>(data.c_str()));
      WriteString2BLE("\n");
      //file.println(data.c_str());
      //writeFile(SD, dt.c_str(), data.c_str());    
    }
  }
